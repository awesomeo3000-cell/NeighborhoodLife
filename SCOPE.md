# Neighborhood Life — full scope and evidence ledger (v1.83)
...
- Production `NLNpcInteractionMenu` discovers authored NPC bodies from world-object
  ...
  plus give/request to the in-world context menu.
