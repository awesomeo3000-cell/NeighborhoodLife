...
- Saved outfits are replacement presets: matching layers are retained, unrelated
  ...
  are then equipped. Live automatic unrelated-layer removal remains an evidence gate.
