# Neighborhood Life — full scope and evidence ledger (v1.66)
...
1. Verify global-data crash atomicity and broaden household routines; v1.63 proves a guest main-inventory retrieve from the production furnishing, v1.64 proves household storage membership/furnishing/item persistence across a dedicated-server restart, and v1.66 proves arbitrary item/container metadata capture and restoration in a real host+guest run.
