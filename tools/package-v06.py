...
root=Path('E:/pzmod'); ev=root/'evidence/v06'; src=root/'NeighborhoodLife'; base=ev/'baseline'
record=['Changed: three career aspiration milestones, one-time credit rewards, journal progress, authoritative delivery/promotion hooks.',
