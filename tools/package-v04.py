...
root=Path('E:/pzmod'); ev=root/'evidence/v04'; src=root/'NeighborhoodLife'; base=ev/'baseline'
record=['Changed: new NL/WardrobePanel.lua; needs HUD three-way Careers/Social/Wardrobe navigation.',
